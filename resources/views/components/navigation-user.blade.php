...
<style>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                    ...
                    @if(Auth::user()->id_rol == 1)
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                const switchCheckbox = document.getElementById('redirectSwitch');
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('mis_canciones')">
                            {{ __('Mis canciones') }}
                        </x-dropdown-link>

                        <x-dropdown-link :href="route('mis_favoritos')">
                            {{ __('Canciones Favoritas') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('artistas')" :active="request()->routeIs('artistas')">
                {{ __('Artistas') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('mis_canciones')">
                    {{ __('Mis canciones') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('mis_favoritos')">
                    {{ __('Canciones favoritas') }}
                </x-responsive-nav-link>
