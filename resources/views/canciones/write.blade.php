                            ...
                            <div class="justify-center text-left h-32 bg-gray-200 columna-vertical" style="margin-right: 10px;">
                                ...
                                <div class="flex flex-col text-left h-32 bg-gray-200">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="nom_canco" id="nom_canco" class="text-white mt-1 block w-full p-2 border border-gray-300 dark:bg-gray-700 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500" required>
                                    </div>
                                    ...
                                    <div class="mt-6 flex justify-between">
                                        <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Publicar canción</button>
